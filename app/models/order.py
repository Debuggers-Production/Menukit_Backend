...
class Order(Base, UUIDMixin, TimestampMixin):
    ...
    order_status: Mapped[str] = mapped_column(String(50), default="pending", nullable=False)  # 'pending', 'accepted', 'rejected', 'completed', 'cancelled'
    payment_status: Mapped[str] = mapped_column(String(50), default="pending", nullable=False)  # 'pending', 'paid', 'failed'
